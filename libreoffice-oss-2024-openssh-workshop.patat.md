---
title: 'Back to basics - Exploring OpenSSH: Hands-On Workshop for Beginners'
...
**LibreOffice and Open Source
Conference 2024 - Luxembourg**

**Back to basics - Exploring OpenSSH: Hands-On Workshop for Beginners**

William Robinet (Conostix S.A.) - 2024-10-11
...
Matrix Room (cfr paper QR Code):
    ...
    https://matrix.to/#/#LibreOfficeConf_2024_OpenSSH-Workshop:matrix.org
...
```bash
git clone https://github.com/wllm-rbnt/libreoffice-oss-2024-openssh-workshop.git
cd libreoffice-oss-2024-openssh-workshop
```
...
- Slides:
    ...
    * HTML (rendered version) -> `https://tinyurl.com/4yvmn8dh`
    * PDF (rendered version) -> `https://tinyurl.com/yevwvby7`
...
- Retrieve the server keys fingerprints through a secure channel:
    ...
    https://github.com/wllm-rbnt/libreoffice-oss-2024-openssh-workshop/blob/main/fingerprints.txt
...
**Note**: *internal* host key fingerprints available at https://github.com/wllm-rbnt/libreoffice-oss-2024-openssh-workshop/blob/main/fingerprints.txt
