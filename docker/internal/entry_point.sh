...
echo 'This is the secret Intranet on internal-machine listening on 127.0.0.1 port 80.' > /var/www/html/index.html
...
echo "IP address(es) of "internal-machine": $(hostname -i)"
exec "$@"
